	...
	<view class="deposit-container">
		...
		<view class="deposit-content">
			...
			<view class="info-card">
				...
				<view class="info-item">
					...
					<view class="type-select">
						<select v-model="selecttype" @change="changetype()" class="select-control">
							...
							<option value="5" class="option-item">USDC</option> 
				...
				<view class="info-item">
					<text class="info-label">{{show_name}}:USDT</text>
					<text class="info-value">{{show_percent}}</text>
				</view>

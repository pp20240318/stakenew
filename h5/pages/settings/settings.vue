	...
	<view class="settings-container">
		...
		<view class="settings-section">
			...
			<view class="settings-item">
				...
				<view class="item-right">
					<switch :checked="tradeConfirm" @change="toggleTradeConfirm" color="#007AFF"/>
				</view>
			</view>
		</view>
		...
		<view class="settings-section">
			...
			<view class="settings-item">
				...
				<view class="item-right">
					<switch :checked="priceAlert" @change="togglePriceAlert" color="#007AFF"/>
				</view>
			</view>
			...
			<view class="settings-item">
				...
				<view class="item-right">
					<switch :checked="tradeNotification" @change="toggleTradeNotification" color="#007AFF"/>
				</view>
			</view>
			...
			<view class="settings-item">
				...
				<view class="item-right">
					<switch :checked="systemNotification" @change="toggleSystemNotification" color="#007AFF"/>
				</view>
			</view>
		</view>
		...
		<view class="settings-section">
			...
			<view class="settings-item">
				...
				<view class="item-right">
					<switch :checked="darkMode" @change="toggleDarkMode" color="#007AFF"/>
				</view>
			</view>

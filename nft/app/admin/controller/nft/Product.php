...
class Product extends Backend
{
    ...
    protected array $withJoinTable = ['level'];

    protected string|array $quickSearchField = ['computer_name', 'id'];
...
//        halt($this->request->param('order'),$this->request->param('product_id'));

...
//    }
    ...
    public function currencyTable(): \think\model\relation\BelongsTo
    {
        return $this->belongsTo(\app\admin\model\Basicset::class, 'currency', 'code');
    }

    public function product(): \think\model\relation\BelongsTo
    {
        return $this->belongsTo(\app\admin\model\nft\Product::class, 'business_id', 'id');
    }

    public function purchase(): \think\model\relation\BelongsTo
    {
        return $this->belongsTo(\app\admin\model\nft\Purchase::class, 'parent_id', 'id');
    }
}
...
class AllowCrossDomain
{
    protected array $header = [ 
        ...
        'Access-Control-Allow-Headers'     => 'think-lang, server,token, ba_user_token, ba-user-token, ba_token, ba-token, batoken, Authorization, Content-Type, If-Match, If-Modified-Since, If-None-Match, If-Unmodified-Since, X-CSRF-TOKEN, X-Requested-With',
    ];

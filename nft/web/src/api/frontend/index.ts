        ...
        createAxios({
            ...
            if (!isEmpty(res.data.userInfo)) {
                ...
                const stakeMenus = [
                    ...
                    {
                        path: '/user/stake/referral',
                        name: 'userStakeReferral',
                        meta: {
                    ...
                    {
                        path: '/user/stake/wallet',
                        name: 'userStakeWallet',
                        meta: {
                            title: 'Stake Wallet',
                            icon: 'fa fa-wallet',
                        },
                ...
                // Add stake menus to the member center
                if (res.data.menus) {
                    res.data.menus.push({
                        path: '/user/stake',
                        name: 'userStake',
                ...
                // Update routes with stake menus
                handleFrontendRoute(res.data.rules, res.data.menus)
            }

        ...
        <el-scrollbar v-loading="baTable.form.loading" class="ba-table-form-scrollbar">
            ...
            >
                ...
                >
                    ...
                    <FormItem :label="t('auth.admin.salesman')" type="switch" v-model="baTable.form.items!.salesman" prop="salesman" :input-attr="{ content: { '0': t('user.user.salesman 0'), '1': t('user.user.salesman 1') } }" />
                    <FormItem
                        :label="t('State')"
...
const rules: Partial<Record<string, FormItemRule[]>> = reactive({
    username: [buildValidatorData({ name: 'required', title: t('auth.admin.username') })],

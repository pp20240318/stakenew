                ...
                >
                    <FormItem
                        ...
                        :input-attr="{
                            ...
                            tooltipParams: {id: 'id',用户名: 'username',电话: 'mobile',},
                            onChange: getAdd,
                            
                        }"
                    />
                    <!-- <el-form-item :label="t('user.moneyLog.business_type')">
                        <el-radio-group v-model="baTable.form.items!.business_type">
                            <el-radio class="ba-el-radio" value="3" :border="true">机器人买卖</el-radio> 
                        </el-radio-group> 
                    </el-form-item> -->
                    <el-form-item :label="t('user.moneyLog.business_type')">
                        <el-input v-model="baTable.form.items!.business_type"  ></el-input>
                    </el-form-item>  
